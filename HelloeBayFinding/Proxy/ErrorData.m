...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT_ARRAY xmlName:@"parameter" propertyName:@"parameter" type:PICO_TYPE_OBJECT clazz:[ErrorParameter class]];
