...
@implementation CategoryHistogramContainer
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT_ARRAY xmlName:@"categoryHistogram" propertyName:@"categoryHistogram" type:PICO_TYPE_OBJECT clazz:[CategoryHistogram class]];
