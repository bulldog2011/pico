...
*/
NSString *const AckValue_SUCCESS = @"Success";
...
*/
NSString *const AckValue_FAILURE = @"Failure";
...
*/
NSString *const AckValue_WARNING = @"Warning";
...
*/
NSString *const AckValue_PARTIAL_FAILURE = @"PartialFailure";
