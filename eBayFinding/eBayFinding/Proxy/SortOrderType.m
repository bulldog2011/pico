...
*/
NSString *const SortOrderType_BEST_MATCH = @"BestMatch";
...
*/
NSString *const SortOrderType_CURRENT_PRICE_HIGHEST = @"CurrentPriceHighest";
...
*/
NSString *const SortOrderType_DISTANCE_NEAREST = @"DistanceNearest";
...
*/
NSString *const SortOrderType_END_TIME_SOONEST = @"EndTimeSoonest";
...
*/
NSString *const SortOrderType_PRICE_PLUS_SHIPPING_LOWEST = @"PricePlusShippingLowest";
...
*/
NSString *const SortOrderType_PRICE_PLUS_SHIPPING_HIGHEST = @"PricePlusShippingHighest";
...
*/
NSString *const SortOrderType_START_TIME_NEWEST = @"StartTimeNewest";
...
*/
NSString *const SortOrderType_BID_COUNT_MOST = @"BidCountMost";
...
*/
NSString *const SortOrderType_BID_COUNT_FEWEST = @"BidCountFewest";
...
*/
NSString *const SortOrderType_COUNTRY_ASCENDING = @"CountryAscending";
...
*/
NSString *const SortOrderType_COUNTRY_DESCENDING = @"CountryDescending";
