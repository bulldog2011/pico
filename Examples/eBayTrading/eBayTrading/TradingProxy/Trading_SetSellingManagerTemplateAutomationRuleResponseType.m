...
@implementation Trading_SetSellingManagerTemplateAutomationRuleResponseType
...
+(PicoClassSchema *)getClassMetaData {
    PicoClassSchema *cs = [[PicoClassSchema alloc] initWithXmlName:@"SetSellingManagerTemplateAutomationRuleResponse" nsUri:@"urn:ebay:apis:eBLBaseComponents"];
    [cs autorelease];
    return cs;
}
