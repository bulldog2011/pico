...
*/
NSString *const Trading_ErrorClassificationCodeType_REQUEST_ERROR = @"RequestError";
...
*/
NSString *const Trading_ErrorClassificationCodeType_SYSTEM_ERROR = @"SystemError";
...
*/
NSString *const Trading_ErrorClassificationCodeType_CUSTOM_CODE = @"CustomCode";
