...
*/
NSString *const Trading_DisputeReasonCodeType_TRANSACTION_MUTUALLY_CANCELED = @"TransactionMutuallyCanceled";
...
*/
NSString *const Trading_DisputeReasonCodeType_ITEM_NOT_RECEIVED = @"ItemNotReceived";
...
*/
NSString *const Trading_DisputeReasonCodeType_SIGNIFICANTLY_NOT_AS_DESCRIBED = @"SignificantlyNotAsDescribed";
...
*/
NSString *const Trading_DisputeReasonCodeType_NO_REFUND = @"NoRefund";
...
*/
NSString *const Trading_DisputeReasonCodeType_RETURN_POLICY_UNPAID_ITEM = @"ReturnPolicyUnpaidItem";
...
*/
NSString *const Trading_DisputeReasonCodeType_CUSTOM_CODE = @"CustomCode";
