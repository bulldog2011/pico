...
*/
extern NSString *const Trading_StringMatchCodeType_CUSTOM_CODE;
...
*/
extern NSString *const Trading_StringMatchCodeType_STARTS_WITH;
...
*/
extern NSString *const Trading_StringMatchCodeType_CONTAINS;
