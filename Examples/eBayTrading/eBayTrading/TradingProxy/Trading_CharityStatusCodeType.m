...
*/
NSString *const Trading_CharityStatusCodeType_VALID = @"Valid";
...
*/
NSString *const Trading_CharityStatusCodeType_NO_LONGER_VALID = @"NoLongerValid";
...
*/
NSString *const Trading_CharityStatusCodeType_CUSTOM_CODE = @"CustomCode";
