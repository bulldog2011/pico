...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_3 = @"Days_3";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_7 = @"Days_7";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_10 = @"Days_10";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_14 = @"Days_14";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_30 = @"Days_30";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_DAYS_60 = @"Days_60";
...
*/
NSString *const Trading_ReturnsWithinOptionsCodeType_CUSTOM_CODE = @"CustomCode";
