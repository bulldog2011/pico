...
@implementation Trading_ShippingLocationDetailsType

@synthesize shippingLocation = _shippingLocation;
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"ShippingLocation" propertyName:@"shippingLocation" type:PICO_TYPE_STRING clazz:nil];
    [map setObject:ps forKey:@"shippingLocation"];
    [ps release];
