...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_EXCELLENT = @"Excellent";
...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_GOOD = @"Good";

NSString *const Trading_BuyerSatisfactionStatusCodeType_NEEDS_WORK = @"NeedsWork";
...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_POOR = @"Poor";
...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_VERY_POOR = @"VeryPoor";
...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_UNACCEPTABLE = @"Unacceptable";
...
*/
NSString *const Trading_BuyerSatisfactionStatusCodeType_CUSTOM_CODE = @"CustomCode";
