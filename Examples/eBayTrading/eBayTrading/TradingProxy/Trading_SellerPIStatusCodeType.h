...
*/
extern NSString *const Trading_SellerPIStatusCodeType_ACCEPTED_UA;
...
*/
extern NSString *const Trading_SellerPIStatusCodeType_MUST_ACCEPT_UA;
...
*/
extern NSString *const Trading_SellerPIStatusCodeType_PI_ENABLED;
...
*/
extern NSString *const Trading_SellerPIStatusCodeType_CUSTOM_CODE;
