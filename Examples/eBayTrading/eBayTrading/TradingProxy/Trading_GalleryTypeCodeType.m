...
*/
NSString *const Trading_GalleryTypeCodeType_NONE = @"None";
...
*/
NSString *const Trading_GalleryTypeCodeType_FEATURED = @"Featured";
...
*/
NSString *const Trading_GalleryTypeCodeType_GALLERY = @"Gallery";
...
*/
NSString *const Trading_GalleryTypeCodeType_PLUS = @"Plus";
...
*/
NSString *const Trading_GalleryTypeCodeType_CUSTOM_CODE = @"CustomCode";
