...
*/
extern NSString *const Trading_MinimumAdvertisedPriceExposureCodeType_DURING_CHECKOUT;
...
*/
extern NSString *const Trading_MinimumAdvertisedPriceExposureCodeType_CUSTOM_CODE;
