...
@implementation Trading_DiscountPriceInfoType
...
@synthesize madeForOutletComparisonPrice = _madeForOutletComparisonPrice;
@synthesize any = _any;
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"OriginalRetailPrice" propertyName:@"originalRetailPrice" type:PICO_TYPE_OBJECT clazz:[Trading_AmountType class]];
    [map setObject:ps forKey:@"originalRetailPrice"];
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"MinimumAdvertisedPrice" propertyName:@"minimumAdvertisedPrice" type:PICO_TYPE_OBJECT clazz:[Trading_AmountType class]];
    ...
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"MadeForOutletComparisonPrice" propertyName:@"madeForOutletComparisonPrice" type:PICO_TYPE_OBJECT clazz:[Trading_AmountType class]];
    [map setObject:ps forKey:@"madeForOutletComparisonPrice"];
    [ps release];
...
-(void)dealloc {
    ...
    self.madeForOutletComparisonPrice = nil;
    self.any = nil;
    [super dealloc];
}
