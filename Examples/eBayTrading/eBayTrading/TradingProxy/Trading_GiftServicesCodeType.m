...
*/
NSString *const Trading_GiftServicesCodeType_GIFT_EXPRESS_SHIPPING = @"GiftExpressShipping";
...
*/
NSString *const Trading_GiftServicesCodeType_GIFT_SHIP_TO_RECIPIENT = @"GiftShipToRecipient";
...
*/
NSString *const Trading_GiftServicesCodeType_GIFT_WRAP = @"GiftWrap";
...
*/
NSString *const Trading_GiftServicesCodeType_CUSTOM_CODE = @"CustomCode";
