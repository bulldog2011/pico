...
@class Trading_SellerProfilesType;
...
@class Trading_QuantityInfoType;
...
@class Trading_ShipPackageDetailsType;
...
@class Trading_QuantityRestrictionPerBuyerInfoType;
...
*/
@interface Trading_ItemType : NSObject <PicoBindable> {

@private
    NSString *_applicationData;
    Trading_AttributeSetArrayType *_attributeSetArray;
    Trading_AttributeArrayType *_attributeArray;
    Trading_LookupAttributeArrayType *_lookupAttributeArray;
    NSNumber *_autoPay;
    Trading_PaymentDetailsType *_paymentDetails;
    Trading_BiddingDetailsType *_biddingDetails;
    NSNumber *_motorsGermanySearchable;
    NSString *_buyerProtection;
    Trading_AmountType *_buyItNowPrice;
    NSNumber *_categoryMappingAllowed;
    Trading_CharityType *_charity;
    NSString *_country;
    Trading_CrossPromotionsType *_crossPromotion;
    NSString *_currency;
    NSString *_description;
    NSString *_descriptionReviseMode;
    Trading_DistanceType *_distance;
    NSNumber *_giftIcon;
    NSMutableArray *_giftServices;
    NSString *_hitCounter;
    NSString *_itemID;
    Trading_ListingDetailsType *_listingDetails;
    Trading_ListingDesignerType *_listingDesigner;
    NSString *_listingDuration;
    NSMutableArray *_listingEnhancement;
    ...
    Trading_CategoryType *_primaryCategory;
    NSNumber *_privateListing;
    Trading_ProductListingDetailsType *_productListingDetails;
    NSNumber *_quantity;
    NSString *_privateNotes;
    NSString *_regionID;
    NSNumber *_relistLink;
    Trading_AmountType *_reservePrice;
    Trading_ReviseStatusType *_reviseStatus;
    NSDate *_scheduleTime;
    Trading_CategoryType *_secondaryCategory;
    Trading_CategoryType *_freeAddedCategory;
    ...
    Trading_StorefrontType *_storefront;
    NSString *_subTitle;
    NSString *_timeLeft;
    NSString *_title;
    NSString *_uuid;
    Trading_VATDetailsType *_vatDetails;
    NSString *_sellerVacationNote;
    NSNumber *_watchCount;
    NSNumber *_hitCount;
    NSNumber *_disableBuyerRequirements;
    Trading_BestOfferDetailsType *_bestOfferDetails;
    NSNumber *_locationDefaulted;
    NSNumber *_thirdPartyCheckout;
    NSNumber *_useTaxTable;
    NSNumber *_getItFast;
    NSNumber *_buyerResponsibleForShipping;
    NSNumber *_limitedWarrantyEligible;
    NSString *_eBayNotes;
    NSNumber *_questionCount;
    NSNumber *_relisted;
    NSNumber *_quantityAvailable;
    NSString *_sku;
    NSNumber *_categoryBasedAttributesPrefill;
    Trading_SearchDetailsType *_searchDetails;
    NSString *_postalCode;
    NSNumber *_shippingTermsInDescription;
    Trading_ExternalProductIDType *_externalProductID;
    NSString *_sellerInventoryID;
    Trading_PictureDetailsType *_pictureDetails;
    NSNumber *_dispatchTimeMax;
    NSNumber *_skypeEnabled;
    NSString *_skypeID;
    NSMutableArray *_skypeContactOption;
    NSNumber *_bestOfferEnabled;
    NSNumber *_localListing;
    NSNumber *_thirdPartyCheckoutIntegration;
    Trading_ListingCheckoutRedirectPreferenceType *_listingCheckoutRedirectPreference;
    Trading_AddressType *_sellerContactDetails;
    NSNumber *_totalQuestionCount;
    NSNumber *_proxyItem;
    Trading_ExtendedContactDetailsType *_extendedSellerContactDetails;
    NSNumber *_leadCount;
    NSNumber *_newLeadCount;
    Trading_NameValueListArrayType *_itemSpecifics;
    NSString *_groupCategoryID;
    Trading_AmountType *_classifiedAdPayPerLeadFee;
    NSNumber *_bidGroupItem;
    Trading_BuyerProtectionDetailsType *_applyBuyerProtection;
    NSString *_listingSubtype2;
    NSNumber *_mechanicalCheckAccepted;
    NSNumber *_updateSellerInfo;
    NSNumber *_updateReturnPolicy;
    Trading_ItemPolicyViolationType *_itemPolicyViolation;
    NSMutableArray *_crossBorderTrade;
    Trading_BusinessSellerDetailsType *_businessSellerDetails;
    Trading_AmountType *_buyerGuaranteePrice;
    Trading_BuyerRequirementDetailsType *_buyerRequirementDetails;
    Trading_ReturnPolicyType *_returnPolicy;
    ...
    Trading_ItemCompatibilityListType *_itemCompatibilityList;
    ...
    NSNumber *_postCheckoutExperienceEnabled;
    Trading_DiscountPriceInfoType *_discountPriceInfo;
    NSNumber *_useRecommendedProduct;
    NSString *_sellerProvidedTitle;
    NSString *_vin;
    NSString *_vinLink;
    NSString *_vrm;
    NSString *_vrmLink;
    Trading_QuantityInfoType *_quantityInfo;
    Trading_SellerProfilesType *_sellerProfiles;
    Trading_ShipPackageDetailsType *_shippingPackageDetails;
    NSNumber *_topRatedListing;
    Trading_AmountType *_floorPrice;
    Trading_AmountType *_ceilingPrice;
    Trading_QuantityRestrictionPerBuyerInfoType *_quantityRestrictionPerBuyer;
    NSNumber *_isIntermediatedShippingEligible;
    Trading_UnitInfoType *_unitInfo;
    NSNumber *_relistParentID;
    NSString *_conditionDefinition;
    NSNumber *_hideFromSearch;
    NSString *_reasonHideFromSearch;
    NSMutableArray *_any;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, retain) NSNumber *postCheckoutExperienceEnabled;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, retain) NSNumber *useRecommendedProduct;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, retain) NSString *sellerProvidedTitle;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, retain) NSString *vinLink;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, retain) NSString *vrm;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, retain) NSString *vrmLink;
...
/**
 ...
 type : class Trading_QuantityInfoType
*/
@property (nonatomic, retain) Trading_QuantityInfoType *quantityInfo;
...
/**
 ...
 type : class Trading_SellerProfilesType
*/
@property (nonatomic, retain) Trading_SellerProfilesType *sellerProfiles;
...
/**
 ...
 type : class Trading_ShipPackageDetailsType
*/
@property (nonatomic, retain) Trading_ShipPackageDetailsType *shippingPackageDetails;
...
/**
 ...
 type : class Trading_AmountType
*/
@property (nonatomic, retain) Trading_AmountType *floorPrice;
...
/**
 ...
 type : class Trading_AmountType
*/
@property (nonatomic, retain) Trading_AmountType *ceilingPrice;
...
/**
 ...
 type : class Trading_QuantityRestrictionPerBuyerInfoType
*/
@property (nonatomic, retain) Trading_QuantityRestrictionPerBuyerInfoType *quantityRestrictionPerBuyer;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, retain) NSNumber *isIntermediatedShippingEligible;
...
/**
 ...
 type : class Trading_UnitInfoType
*/
@property (nonatomic, retain) Trading_UnitInfoType *unitInfo;
...
/**
 ...
 type : NSString, wrapper for primitive string
*/
@property (nonatomic, retain) NSString *conditionDefinition;
...
/**
 ...
 type : NSNumber, wrapper for primitive bool
*/
@property (nonatomic, retain) NSNumber *hideFromSearch;
...
/**
 ...
 type: string constant in Trading_ReasonHideFromSearchCodeType.h
*/
@property (nonatomic, retain) NSString *reasonHideFromSearch;
