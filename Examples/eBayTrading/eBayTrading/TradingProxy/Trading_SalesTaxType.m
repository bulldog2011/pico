...
@implementation Trading_SalesTaxType
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"SalesTaxAmount" propertyName:@"salesTaxAmount" type:PICO_TYPE_OBJECT clazz:[Trading_AmountType class]];
