...
*/
extern NSString *const Trading_RefundFailureCodeType_PAYPAL_BILLING_AGREEMENT_CANCELED;
...
*/
extern NSString *const Trading_RefundFailureCodeType_PAYPAL_RISK_DECLINES_TRANSACTION;
...
*/
extern NSString *const Trading_RefundFailureCodeType_CUSTOM_CODE;
