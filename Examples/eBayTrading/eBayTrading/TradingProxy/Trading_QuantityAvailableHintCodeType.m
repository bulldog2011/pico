...
*/
NSString *const Trading_QuantityAvailableHintCodeType_LIMITED = @"Limited";
...
*/
NSString *const Trading_QuantityAvailableHintCodeType_MORE_THAN = @"MoreThan";
...
*/
NSString *const Trading_QuantityAvailableHintCodeType_CUSTOM_CODE = @"CustomCode";
