...
*/
NSString *const Trading_InventoryTrackingMethodCodeType_ITEM_ID = @"ItemID";
...
*/
NSString *const Trading_InventoryTrackingMethodCodeType_SKU = @"SKU";
...
*/
NSString *const Trading_InventoryTrackingMethodCodeType_CUSTOM_CODE = @"CustomCode";
