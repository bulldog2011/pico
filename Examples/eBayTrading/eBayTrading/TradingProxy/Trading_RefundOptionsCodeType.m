...
*/
NSString *const Trading_RefundOptionsCodeType_MONEY_BACK = @"MoneyBack";
...
*/
NSString *const Trading_RefundOptionsCodeType_EXCHANGE = @"Exchange";
...
*/
NSString *const Trading_RefundOptionsCodeType_MERCHANDISE_CREDIT = @"MerchandiseCredit";
...
*/
NSString *const Trading_RefundOptionsCodeType_MONEY_BACK_OR_EXCHANGE = @"MoneyBackOrExchange";
...
*/
NSString *const Trading_RefundOptionsCodeType_CUSTOM_CODE = @"CustomCode";
