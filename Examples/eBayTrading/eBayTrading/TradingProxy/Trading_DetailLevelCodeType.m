...
*/
NSString *const Trading_DetailLevelCodeType_RETURN_ALL = @"ReturnAll";
...
*/
NSString *const Trading_DetailLevelCodeType_ITEM_RETURN_DESCRIPTION = @"ItemReturnDescription";
...
*/
NSString *const Trading_DetailLevelCodeType_ITEM_RETURN_ATTRIBUTES = @"ItemReturnAttributes";
...
*/
NSString *const Trading_DetailLevelCodeType_ITEM_RETURN_CATEGORIES = @"ItemReturnCategories";
...
*/
NSString *const Trading_DetailLevelCodeType_RETURN_SUMMARY = @"ReturnSummary";
...
*/
NSString *const Trading_DetailLevelCodeType_RETURN_HEADERS = @"ReturnHeaders";
...
*/
NSString *const Trading_DetailLevelCodeType_RETURN_MESSAGES = @"ReturnMessages";
