...
@implementation Trading_DeleteSellingManagerItemAutomationRuleResponseType
...
+(PicoClassSchema *)getClassMetaData {
    PicoClassSchema *cs = [[PicoClassSchema alloc] initWithXmlName:@"DeleteSellingManagerItemAutomationRuleResponse" nsUri:@"urn:ebay:apis:eBLBaseComponents"];
    [cs autorelease];
    return cs;
}
