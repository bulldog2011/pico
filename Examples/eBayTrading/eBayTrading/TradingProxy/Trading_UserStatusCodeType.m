...
*/
NSString *const Trading_UserStatusCodeType_UNKNOWN = @"Unknown";
...
*/
NSString *const Trading_UserStatusCodeType_SUSPENDED = @"Suspended";
...
*/
NSString *const Trading_UserStatusCodeType_CONFIRMED = @"Confirmed";
...
*/
NSString *const Trading_UserStatusCodeType_UNCONFIRMED = @"Unconfirmed";
...
*/
NSString *const Trading_UserStatusCodeType_GHOST = @"Ghost";
...
*/
NSString *const Trading_UserStatusCodeType_IN_MAINTENANCE = @"InMaintenance";
...
*/
NSString *const Trading_UserStatusCodeType_DELETED = @"Deleted";
...
*/
NSString *const Trading_UserStatusCodeType_CREDIT_CARD_VERIFY = @"CreditCardVerify";
...
*/
NSString *const Trading_UserStatusCodeType_ACCOUNT_ON_HOLD = @"AccountOnHold";
...
*/
NSString *const Trading_UserStatusCodeType_MERGED = @"Merged";
...
*/
NSString *const Trading_UserStatusCodeType_REGISTRATION_CODE_MAIL_OUT = @"RegistrationCodeMailOut";
...
*/
NSString *const Trading_UserStatusCodeType_TERM_PENDING = @"TermPending";
...
*/
NSString *const Trading_UserStatusCodeType_UNCONFIRMED_HALF_OPT_IN = @"UnconfirmedHalfOptIn";
...
*/
NSString *const Trading_UserStatusCodeType_CREDIT_CARD_VERIFY_HALF_OPT_IN = @"CreditCardVerifyHalfOptIn";

NSString *const Trading_UserStatusCodeType_UNCONFIRMED_PASSPORT = @"UnconfirmedPassport";

NSString *const Trading_UserStatusCodeType_CREDIT_CARD_VERIFY_PASSPORT = @"CreditCardVerifyPassport";

NSString *const Trading_UserStatusCodeType_UNCONFIRMED_EXPRESS = @"UnconfirmedExpress";
...
*/
NSString *const Trading_UserStatusCodeType_GUEST = @"Guest";
...
*/
NSString *const Trading_UserStatusCodeType_CUSTOM_CODE = @"CustomCode";
