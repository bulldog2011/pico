...
*/
@interface SimilarityLookup : NSObject <PicoBindable> {
...
@private
    ...
    SimilarityLookupRequest *_shared;
...
*/
@property (nonatomic, retain) SimilarityLookupRequest *shared;

/**
 (public property)
 
 entry type : class SimilarityLookupRequest
*/
