...
*/
NSString *const ItemFilterType_CONDITION = @"Condition";
...
*/
NSString *const ItemFilterType_CURRENCY = @"Currency";
...
*/
NSString *const ItemFilterType_END_TIME_FROM = @"EndTimeFrom";
...
*/
NSString *const ItemFilterType_MOD_TIME_FROM = @"ModTimeFrom";
...
*/
NSString *const ItemFilterType_END_TIME_TO = @"EndTimeTo";
...
*/
NSString *const ItemFilterType_EXCLUDE_AUTO_PAY = @"ExcludeAutoPay";
...
*/
NSString *const ItemFilterType_BEST_OFFER_ONLY = @"BestOfferOnly";
...
*/
NSString *const ItemFilterType_FEATURED_ONLY = @"FeaturedOnly";
...
*/
NSString *const ItemFilterType_FEEDBACK_SCORE_MAX = @"FeedbackScoreMax";
...
*/
NSString *const ItemFilterType_FEEDBACK_SCORE_MIN = @"FeedbackScoreMin";
...
*/
NSString *const ItemFilterType_FREE_SHIPPING_ONLY = @"FreeShippingOnly";
...
*/
NSString *const ItemFilterType_GET_IT_FAST_ONLY = @"GetItFastOnly";
...
*/
NSString *const ItemFilterType_HIDE_DUPLICATE_ITEMS = @"HideDuplicateItems";
...
*/
NSString *const ItemFilterType_AVAILABLE_TO = @"AvailableTo";
...
*/
NSString *const ItemFilterType_LOCATED_IN = @"LocatedIn";
...
*/
NSString *const ItemFilterType_LOCAL_PICKUP_ONLY = @"LocalPickupOnly";
...
*/
NSString *const ItemFilterType_LOCAL_SEARCH_ONLY = @"LocalSearchOnly";
...
*/
NSString *const ItemFilterType_LISTING_TYPE = @"ListingType";
...
*/
NSString *const ItemFilterType_LOTS_ONLY = @"LotsOnly";
...
*/
NSString *const ItemFilterType_MAX_BIDS = @"MaxBids";
...
*/
NSString *const ItemFilterType_MIN_BIDS = @"MinBids";
...
*/
NSString *const ItemFilterType_MAX_PRICE = @"MaxPrice";
...
*/
NSString *const ItemFilterType_MIN_PRICE = @"MinPrice";
...
*/
NSString *const ItemFilterType_PAYMENT_METHOD = @"PaymentMethod";
...
*/
NSString *const ItemFilterType_MAX_QUANTITY = @"MaxQuantity";
...
*/
NSString *const ItemFilterType_MIN_QUANTITY = @"MinQuantity";
...
*/
NSString *const ItemFilterType_SELLER = @"Seller";
...
*/
NSString *const ItemFilterType_EXCLUDE_SELLER = @"ExcludeSeller";
...
*/
NSString *const ItemFilterType_EXCLUDE_CATEGORY = @"ExcludeCategory";
...
*/
NSString *const ItemFilterType_WORLD_OF_GOOD_ONLY = @"WorldOfGoodOnly";
...
*/
NSString *const ItemFilterType_MAX_DISTANCE = @"MaxDistance";
...
*/
NSString *const ItemFilterType_SELLER_BUSINESS_TYPE = @"SellerBusinessType";
...
*/
NSString *const ItemFilterType_TOP_RATED_SELLER_ONLY = @"TopRatedSellerOnly";
...
*/
NSString *const ItemFilterType_SOLD_ITEMS_ONLY = @"SoldItemsOnly";
...
*/
NSString *const ItemFilterType_CHARITY_ONLY = @"CharityOnly";
...
*/
NSString *const ItemFilterType_LISTED_IN = @"ListedIn";
...
*/
NSString *const ItemFilterType_EXPEDITED_SHIPPING_TYPE = @"ExpeditedShippingType";
...
*/
NSString *const ItemFilterType_MAX_HANDLING_TIME = @"MaxHandlingTime";
...
*/
NSString *const ItemFilterType_RETURNS_ACCEPTED_ONLY = @"ReturnsAcceptedOnly";
...
*/
NSString *const ItemFilterType_VALUE_BOX_INVENTORY = @"ValueBoxInventory";
...
*/
NSString *const ItemFilterType_OUTLET_SELLER_ONLY = @"OutletSellerOnly";
...
*/
NSString *const ItemFilterType_AUTHORIZED_SELLER_ONLY = @"AuthorizedSellerOnly";
...
*/
NSString *const ItemFilterType_START_TIME_FROM = @"StartTimeFrom";
...
*/
NSString *const ItemFilterType_START_TIME_TO = @"StartTimeTo";
