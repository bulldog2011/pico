...
*/
@interface SellingStatus : NSObject <PicoBindable> {

@private
    Amount *_currentPrice;
    Amount *_convertedCurrentPrice;
    NSNumber *_bidCount;
...
/**
 ...
 type : class Amount
*/
@property (nonatomic, retain) Amount *currentPrice;
...
/**
 ...
 type : class Amount
*/
@property (nonatomic, retain) Amount *convertedCurrentPrice;
