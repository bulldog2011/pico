...
*/
NSString *const Finding_ErrorCategory_SYSTEM = @"System";
...
*/
NSString *const Finding_ErrorCategory_APPLICATION = @"Application";
...
*/
NSString *const Finding_ErrorCategory_REQUEST = @"Request";
