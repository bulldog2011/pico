...
*/
NSString *const Finding_SortOrderType_BEST_MATCH = @"BestMatch";
...
*/
NSString *const Finding_SortOrderType_CURRENT_PRICE_HIGHEST = @"CurrentPriceHighest";
...
*/
NSString *const Finding_SortOrderType_DISTANCE_NEAREST = @"DistanceNearest";
...
*/
NSString *const Finding_SortOrderType_END_TIME_SOONEST = @"EndTimeSoonest";
...
*/
NSString *const Finding_SortOrderType_PRICE_PLUS_SHIPPING_LOWEST = @"PricePlusShippingLowest";
...
*/
NSString *const Finding_SortOrderType_PRICE_PLUS_SHIPPING_HIGHEST = @"PricePlusShippingHighest";
...
*/
NSString *const Finding_SortOrderType_START_TIME_NEWEST = @"StartTimeNewest";
...
*/
NSString *const Finding_SortOrderType_BID_COUNT_MOST = @"BidCountMost";
...
*/
NSString *const Finding_SortOrderType_BID_COUNT_FEWEST = @"BidCountFewest";
...
*/
NSString *const Finding_SortOrderType_COUNTRY_ASCENDING = @"CountryAscending";
...
*/
NSString *const Finding_SortOrderType_COUNTRY_DESCENDING = @"CountryDescending";
