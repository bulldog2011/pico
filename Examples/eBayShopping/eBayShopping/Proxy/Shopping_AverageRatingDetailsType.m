...
@implementation Shopping_AverageRatingDetailsType
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"RatingCount" propertyName:@"ratingCount" type:PICO_TYPE_LONG clazz:nil];
