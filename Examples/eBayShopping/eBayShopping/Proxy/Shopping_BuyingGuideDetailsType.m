...
@implementation Shopping_BuyingGuideDetailsType
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT_ARRAY xmlName:@"BuyingGuide" propertyName:@"buyingGuide" type:PICO_TYPE_OBJECT clazz:[Shopping_BuyingGuideType class]];
