...
/**
 ...
 By default, `PicoRequestOperation` accepts the following MIME types, which includes the official standard, `application/soap+xml`, as well as other commonly-used types:
 
 - `application/soap+xml`
 - `text/xml`
 */
@interface PicoRequestOperation : AFHTTPRequestOperation
 ...
 */
//+ (PicoRequestOperation *)PicoRequestOperationWithRequest:(NSURLRequest *)urlRequest
